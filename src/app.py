...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["mason@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice and stroke improvement sessions",
    ...
    "Drama Club": {
        "description": "Practice acting, stagecraft, and performance production",
